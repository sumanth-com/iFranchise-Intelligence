...
const table = createTableService("trends")

export function createTrendsService(client: SupabaseDbClient) {
  return {
    list: () =>
      table.list(client, { orderBy: "opportunity_score", ascending: false }),
